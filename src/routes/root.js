...
import {SplashScreenPage, HomeScreenPage, LoginScreenPage, point1, point3, point7} from '../pages';
...
const BottomTabNavigator = () => {
  return (
    <Tab.Navigator
      ...
      />
      <Tab.Screen
        name={routes_name.POINT_1}
        component={point1}
        options={{headerShown: false}}
      />
      
      <Tab.Screen
        name={routes_name.POINT_3}
        component={point3}
        options={{headerShown: false}}
      /> 
      <Tab.Screen
        name={routes_name.POINT_7}
        component={point7}
        options={{headerShown: false}}
      />
    </Tab.Navigator>
